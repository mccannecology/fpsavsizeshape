...
shinyServer(function(input, output) {
  ...
  output$cover <- renderImage({
    ...
    url <- paste("https://s3.amazonaws.com/fpsavsizeshape/",sim_numb(),"/cover.jpg",sep="")
  ...
  output$initial <- renderImage({
    ...
    # URL varies depending on input 
    url <- paste("https://s3.amazonaws.com/fpsavsizeshape/",sim_numb(),"/initial.jpg",sep="")
  ...
  output$middle <- renderImage({
    ...
    # URL varies depending on input 
    url <- paste("https://s3.amazonaws.com/fpsavsizeshape/",sim_numb(),"/middle.jpg",sep="")
  ...
  output$final <- renderImage({
    ...
    # URL varies depending on input 
    url <- paste("https://s3.amazonaws.com/fpsavsizeshape/",sim_numb(),"/final.jpg",sep="")
  ...
  output$nutrients <- renderImage({
    ...
    # URL varies depending on input 
    url <- paste("https://s3.amazonaws.com/fpsavsizeshape/",sim_numb(),"/nutrients.jpg",sep="")
